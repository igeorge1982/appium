 ...
 * </ul>
 * <p>
 * Key methods are {@link CustomWebDriver#get(String)}, which is used to load a new web page, and the
 * various methods similar to {@link CustomWebDriver#findElement(By)}, which is used to find
 * {@link WebElement}s.
 * <p>
 ...
 */
public interface CustomWebDriver extends SearchContext {
  // Navigation
  ...
  interface TargetLocator {
     ...
     */
    CustomWebDriver frame(int index);
     ...
     * @throws NoSuchFrameException If the frame cannot be found
     */
    CustomWebDriver frame(String nameOrId);
     ...
     * @see CustomWebDriver#findElement(By)
     */
    CustomWebDriver frame(WebElement frameElement);
     ...
     */
    CustomWebDriver parentFrame();

    /**
     * Switch the focus of future commands for this driver to the window with the given name/handle.
     * 
     * @param nameOrHandle The name of the window or the handle as returned by
     *        {@link CustomWebDriver#getWindowHandle()}
     * @return This driver focused on the given window
     * @throws NoSuchWindowException If the window cannot be found
     */
    CustomWebDriver window(String nameOrHandle);
     ...
     */
    CustomWebDriver defaultContent();
