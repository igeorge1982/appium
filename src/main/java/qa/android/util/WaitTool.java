...
import main.java.qa.android.testng.ExpectedExceptions;
...
public class WaitTool extends TestBase {
	...
	public static WebElement waitForElementDriverWebElementSecond(WebDriver driver, WebElement wElement, int timeOutInSeconds) {
		WebElement element; 
		try{	
			//To use WebDriverWait(), we would have to nullify implicitlyWait(). 
			//Because implicitlyWait time also set "driver.findElement()" wait time.  
